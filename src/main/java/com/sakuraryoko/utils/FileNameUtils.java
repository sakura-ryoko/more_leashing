...
public class FileNameUtils
{
    ...
    public static String wrapJsonFileName(String in)
    {
        in = FileNameUtils.generateSafeFileName(in);
        in = FileNameUtils.generateSimpleUnicodeSafeFileName(in);
        return FileNameUtils.addExtensionIfNotExists(in, ".json");
    }
}
